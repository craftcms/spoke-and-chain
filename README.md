...
- [Node](https://nodejs.org/en/) (16+) / [npm](https://www.npmjs.com/) (8+), managing and building front end resources
...
Run `npm ci` with node 16. (If you’ve installed [nvm](https://github.com/nvm-sh/nvm) run `nvm use`, then `npm ci`.)
